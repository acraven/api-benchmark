...
ab.exe -n 20 http://localhost:8105/
ab.exe -n 40000 -c 20 http://localhost:8105/ > results\aspnetcore-selfhost.txt 
...
ab.exe -n 20 http://localhost:8130/
ab.exe -n 40000 -c 20 http://localhost:8130/ > results\owin-mono-selfhost.txt 
